...
function _M.init_worker()
    ...
    router:insert_route("/apioak/admin/router/{service_id}/{id}/plugin", admin.router.plugin_create, { method = { "POST" } })

    router:insert_route("/apioak/admin/router/{service_id}/{id}/plugin", admin.router.plugin_delete, { method = { "DELETE" } })

    router:insert_route("/apioak/admin/router/{service_id}/{id}/push_upstream", admin.router.push_upstream, { method = { "PUT" } })
